...
faculty_credentials = [
    {"id": "FAC001", "email": "shireen@university.edu", "password": "password123", "name": "Shireen"},
    {"id": "FAC002", "email": "john.doe@university.edu", "password": "admin123", "name": "John Doe"},
    {"id": "FAC003", "email": "jane.smith@university.edu", "password": "faculty123", "name": "Jane Smith"},
    # Simple credentials for testing
    {"id": "admin", "email": "admin@test.com", "password": "admin", "name": "Admin User"},
    {"id": "test", "email": "test@test.com", "password": "test", "name": "Test User"},
]
